...
Config = {
	System = {
		...
		Notify = "ox_lib",		-- This allows you to choose the notification system for scripts
		...
		drawText = "ox_lib",	-- The style of drawText you want to use
							-- "qb" = `qb-core`'s drawText system
							-- "ox" = `ox_lib`'s drawTextUI system
							-- "gta" = Native GTA style popups


		progressBar = "ps-ui" -- The style of progressBar you want to use
